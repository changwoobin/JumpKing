...
while running:
    ...
    ############
        ...
        if y_pos < 90 and y_pos > 54 and x_pos > 800 and before_x < 800:
            to_x *= -1
        elif y_pos < 90 and y_pos > 54 and x_pos < 908 and before_x > 908:
            to_x *= -1

        if y_pos < 90 and before_y > 90 and x_pos > 800 and x_pos < 908:
            to_y *= -1
        elif y_pos > 54 and before_y < 54 and x_pos > 800 and x_pos < 908:
            y_pos = 44
            to_x = 0
        ...
        if y_pos < 94 and before_y > 94 and x_pos > 292 and x_pos < 361:
            to_y *= -1
        elif y_pos > 68 and before_y < 68 and x_pos > 292 and x_pos < 361:
            y_pos = 58
            to_x = 0
        ...
        if y_pos < 216 and y_pos > 180 and x_pos > 600 and before_x < 600:
            to_x *= -1
        elif y_pos < 216 and y_pos > 180 and x_pos < 750 and before_x > 750:
            to_x *= -1

        if y_pos < 216 and before_y > 216 and x_pos > 600 and x_pos < 750:
            to_y *= -1
...
########################################
        if y_pos < 270 and y_pos > 234 and x_pos > 180 and before_x < 180:
            to_x *= -1
        elif y_pos < 270 and y_pos > 234 and x_pos < 348 and before_x > 348:
            to_x *= -1

        if y_pos < 270 and before_y > 270 and x_pos > 180 and x_pos < 348:
            to_y *= -1
...
##
        ...
        if y_pos < 456 and before_y > 456 and x_pos > 257 and x_pos < 326:
            to_y *= -1
...
##
        if y_pos < 595 and y_pos > 500 and x_pos > 26 and before_x < 26:
            to_x *= -1
        elif y_pos < 595 and y_pos > 500 and x_pos < 121 and before_x > 121:
            to_x *= -1

        if y_pos < 595 and before_y > 595 and x_pos > 26 and x_pos < 121:
            to_y *= -1
